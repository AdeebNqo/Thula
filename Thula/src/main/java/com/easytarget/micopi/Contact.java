...
//    }
    ...
    public static Contact buildContact(String contactCellNumber, Context context) {
        if (context==null || contactCellNumber ==null) {
            return null;
        }
        ...
        Uri uri = Uri.withAppendedPath(ContactsContract.PhoneLookup.CONTENT_FILTER_URI, Uri.encode(contactCellNumber));
        ...
        if(cursor!=null) {
            if (cursor.moveToFirst()) {
                ...
                cursor.close();
                contact = buildContact(context, contactId);
            }
        }
