...
public class RetryScheduler implements Observer {
    ...
    private void markMmsFailed(final Context context, Uri msgUri) {
        ...
        // context.sendBroadcast(new Intent(com.adeebnqo.Thula.send_message.Transaction.REFRESH));
        // context.sendBroadcast(new Intent(com.adeebnqo.Thula.send_message.Transaction.NOTIFY_SMS_FAILURE));
